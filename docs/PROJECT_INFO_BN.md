...
- কাস্টমার লিখল: *"Ok 2 ta nibo. Amar number 01712345678. Address: House 12, Dhanmondi, Dhaka"*
...
| **Webhook** | উল্টো API — *ওরা আমাদের* ডাকে; মেসেজ এলে Meta আমাদের URL-এ POST করে |
...
*ফাইলটি F-ComFlow প্রজেক্টের অংশ — CSE Fest 2026 Software Project Showcase-এর জন্য প্রস্তুতকৃত।*
